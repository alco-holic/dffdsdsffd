...
// @namespace    -
// @version
// @description by x-Pro??
// @author       here :P x-Pro#6719 + AyE#7777
...
var Astro = "https://cdn.discordapp.com/attachments/787156693443805225/791584888557797406/y2mate.com_-_Ultra_Instinct_OST_-_EPIC_VERSION__320kbps.mp3"
...
var AStro = "https://cdn.discordapp.com/attachments/787156693443805225/792229502746361886/y2mate.com_-_Warriors_320kbps.mp3"
var MUsiccc = new Audio(AStro);
document.addEventListener('keydown', (e)=>{
...
var ASTro = "https://cdn.discordapp.com/attachments/787156693443805225/792259560995422209/y2mate.com_-_NEFFEX_-_Fight_Back_Official_Video_320kbps.mp3"
var MUSiccc = new Audio(ASTro);
document.addEventListener('keydown', (e)=>{
...
var ASTRo = "https://cdn.discordapp.com/attachments/787156693443805225/792261142042640394/y2mate.com_-_Marshmello_Happier_Bass_Boosted_ft._Bastille_256kbps.mp3"
var MUSIccc = new Audio(ASTRo);
document.addEventListener('keydown', (e)=>{
...
MUSIccc.play();
    ...
    function pwFC1() {
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(180+zawarudo));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(90+zawarudo));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(90+zawarudo));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(180+zawarudo));
        doNewSend(["33", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
        doNewSend(["2", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
    clearTimeout(pw1);
    pw1 = setTimeout(function(){ pwFC2(); }, 70);
    }
    function pwFC2() {
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(180-macro));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(90-macro));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(90-macro));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(180-macro));
        doNewSend(["33", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
        doNewSend(["2", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
    clearTimeout(pw2);
    pw3 = setTimeout(function(){ pwFC3(); }, 70);
    }
    function pwFC3() {
    ...
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(180));
        ...
        doNewSend(["2", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
    clearTimeout(pw3);
    pw4 = setTimeout(function(){ pwFC4(); }, 70);
    }
    function pwFC4() {
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(180+macro));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(90+macro));
    ...
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(180+macro));
        ...
        doNewSend(["2", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
    clearTimeout(pw1);
    pw1 = setTimeout(function(){ pwFC1(); }, 70);
    }
...
let zawarudo = (314159265359-180)*1/*3*/;
let macro = (12345678*90)-(180*1234321);
...
if (item == "h" && data [1] == myPlayer.id) {
  if(data[2] < 80 && data[2] > 0 && testheal==1) {
    setTimeout(() => {
  place(foodType, null)
    }, 150);
  }
...
const healer2 = repeater(81, () => {placeQ(foodType, null);
                                    ...
                                    placeQ(foodType, null);
                                    placeQ(foodType, null);
                                    placeQ(foodType, null);}, 0);
const boostPlacer = repeater(70, () => {place(boostType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(9000000005))
                                       place(boostType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(18000000010))
                                       place(boostType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(27000000015))
                                       place(boostType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(36000000020))
                                       }, 0);



const fourSpawnpader = repeater(226, () => {
    place(spawnpadType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(0));
    }, 0);
const spikePlacer = repeater(86, () => {place(spikeType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(9000000005));
                                       }, 0);
const millPlacer = repeater(78, () => {
 place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(macro+180));
                                       place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(macro+100));
                                       place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(macro+100));
                                      }, 0);
...
var astro = "https://cdn.discordapp.com/attachments/787156693443805225/790076518134710303/y2mate.com_-_Blue__Grey.mp3"
var musiccc = new Audio(astro);
document.addEventListener('keydown', (e)=>{
...
setInterval(function() {
    ...
    document.querySelector("showPing").style.display = true;
}, 1000)
document.addEventListener('keydown', (e)=>{
        ...
        function e() {
            B = Date.now(), P = B - q, q = B,
                ...
                var color = '#' + r1213.toString(16) + g1213.toString(16) + b1213.toString(16);
                            ...
                            be.strokeText("âœ®" ,(R.x-f + _.x-f)/2,(R.y-d +_.y-d)/2),
                            be.fillText("âœ®" ,(R.x-f + _.x-f)/2,(R.y-d +_.y-d)/2)
                            }
